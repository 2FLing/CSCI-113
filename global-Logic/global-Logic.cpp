//****************************************************************************************************************************
//This is a program that simulating memory hierarchy in computers
//funsions:
//int BtoD(string); -> This funtion converts a binary number(represented by string) to decimal.
//string DtoB(int); -> This function converts a decimal number to binary number
//bool mhs(string); -> This function contains the main sturcture of memory hierarchy simulation
//bool lw(string, int); -> This function simulating how load word instruction works in memory hierarchy.
//bool sw(string, int); -> This function simulating how store word instruction works in memory hierarchy.
//void init_data(); -> This function initialize the data container for memories in computer (Main memory(128 words size)
//					   and cache(2way - set - associative, total cache data size is 16 words, one word per block)).
//
//void display(); -> displays the simulation result in format
//****************************************************************************************************************************
#include<iostream>
#include<math.h>
#include<vector>
...
vector<Set>cache;// data construtor
